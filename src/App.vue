			...
			<div class="text-center flex items-center flex-col">
				<template v-if="false">
					...
					<h3 class="leading-8 text-small">
						...
						<p style="color: red">
							但站长的服务仍在继续，站长将运营导航站，收集一些优质免费稳定的AI网站，有需要的请收藏导航页：
							<a
								href="https://free.x-code.fun"
        ...
        <img class="w-[200px]" src="https://file.xjai.top/uploads/2024-04-24-1713980537868-23089102-WechatIMG10833.png"/> -->
          ...
          >https://free.x-code.fun</a> 免费ai导航站其他网站</h3> -->
				...
				<h3 class="text-xl leading-8">
					<a
						href="https://super.xjai.top"
						class="text-blue-500 underline"
						target="_blank"
						>https://super.xjai.top_</a
					>
				</h3>
				<NDivider class="!my-1" />
				<h3 class="text-xl leading-8">
					站长推荐<span class="text-red-500">(广告)</span>：<br />
					本站点同款<span class="text-red-500">服务器</span
					>，性价比超高，仅10元一个月，送免费域名、ssl证书<br />
					<a
						href="https://www.rainyun.com/webpon_"
						class="text-blue-500 underline"
						target="_blank"
